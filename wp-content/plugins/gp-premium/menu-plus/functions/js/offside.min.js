! function(l, a, d) {
    ...
    var e = {
        getInstance: function(e, t) {
            return l.offside.factory || (l.offside.factory = n(t)), l.offside.factory.getOffsideInstance(e, t)
        }
    };

    function n(e) {
        var t, h = function(e) {
                0 < T.length && (isNaN(e) ? T.forEach(function(e) {
                    x[e].close()
                }) : x[e].close())
            },
            L = function() {
            ...
            q = function(e) {
                return e instanceof HTMLElement ? [e] : Array.isArray(e) ? e : "string" == typeof e && Array.apply(null, a.querySelectorAll(e))
            },
            w = function(e, t) {
                var n = e.indexOf(t);
                return -1 < n && n
        ...
        var k = "offside-js",
            ...
            s = !n.disableCss3dTransforms && function() {
                ...
                for (var o in a.body.insertBefore(t, null), n) t.style[o] !== d && (t.style[o] = "translate3d(1px,1px,1px)", e = l.getComputedStyle(t).getPropertyValue(n[o]));
                return a.body.removeChild(t), e !== d && 0 < e.length && "none" !== e
            }(),
            T = [],
            D = a.body,
            r = q(n.slidingElementsSelector),
            N = n.debug;
        ...
        function c(e, t, n) {
            ...
            var l = e,
                ...
                v = n || 0,
                y = function() {
                    i.beforeOpen(), C && (C = !1, L()), h(), S(D, m), S(D, g), S(l, f), T.push(v), i.afterOpen()
                },
                p = function() {
                    var e = w(T, v);
                    !1 !== e && (i.beforeClose(), E(D, m), E(D, g), E(l, f), T.splice(e, 1), i.afterClose())
                },
                b = function() {
                    l || console.error('Offside alert: "offside" selector could not match any element'), c.length || console.error('Offside alert: "buttonsSelector" selector could not match any element')
                };
            this.toggle = function() {
                ...
                i.beforeDestroy(), p(), c.forEach(function(e) {
                    A(e, "click", r)
                }), E(l, d), E(l, u), delete x[v], i.afterDestroy()
            }, N && b(), S(l, d), S(l, u), c.forEach(function(e) {
                O(e, "click", r)
            }), i.init()
        }
        return r.forEach(function(e) {
            S(e, "offside-sliding-element")
        }), s || S(a.documentElement, "no-csstransforms3d"), S(D, o), {
            closeOpenOffside: function() {
                h()
            },
            getOffsideInstance: function(e, t) {
                var n, o, i, s, r = x.length || 0,
                    l = (o = t, i = r, !1 !== (s = q((n = e) !== d ? n : ".offside")) ? new c(s[0], o, i) : null);
                if (null !== l) return x[r] = l
            }
        }
    }
    "undefined" != typeof module && module.exports ? module.exports = e.getInstance : l.offside = e.getInstance
...
for (var generateOffside = offside(".slideout-navigation", {
        ...
        afterOpen: function() {
            document.documentElement.classList.add("slide-opened"), document.body.classList.add("slide-opened");
            var e, t = document.querySelector("ul.slideout-menu");
            !t || (e = t.firstChild.querySelector("a")) && setTimeout(function() {
                e.focus()
            }, 200)
        },
        afterClose: function() {
            ...
            if (document.documentElement.classList.remove("slide-opened"), e.classList.remove("slide-opened"), "true" === document.querySelector(".main-navigation .menu-toggle").getAttribute("aria-expanded") && document.querySelector(".main-navigation .menu-toggle").setAttribute("aria-expanded", !1), e.classList.contains("dropdown-hover"))
                for (var o = document.querySelector(".main-navigation:not(.slideout-navigation)").querySelectorAll("li.menu-item-has-children"), n = 0; n < o.length; n++) {
